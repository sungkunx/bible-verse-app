...
export const reducer = (state, action) => {
  switch (action.type) {
    ...
    case 'SET_SUBSUBCATEGORIES':
      return { ...state, subsubcategories: action.payload };
    case 'SET_VERSES':
      return { ...state, verses: action.payload, currentSubsubcategory: action.subsubcategory };
    ...
    case 'SET_CURRENT_SUBSUBCATEGORY':
      return { ...state, currentSubsubcategory: action.payload };
    ...
    case 'SET_SELECTED_SUBSUBCATEGORIES':
      return { ...state, selectedSubsubcategories: action.payload };
